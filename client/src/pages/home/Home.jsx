          ...
          <div className="max-w-xl">
            ...
            <div className="flex gap-4">
              <button
                ...
                rounded-xl text-lg font-semibold transition active:scale-95"
              >
                Get Started
              </button>
              ...
              <button
                onClick={() => nav("/login")}
                className="border border-white/40 hover:bg-white/10 
                px-8 py-3 rounded-xl text-lg font-semibold transition"
              >
                Browse Venues
              </button>
            </div>
